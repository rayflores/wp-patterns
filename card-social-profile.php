 ...
 * Slug: hpu24/social-profile-card
 * Description:
 * Categories: hpu24/card
...
<figure class="wp-block-image aligncenter size-full is-resized is-style-rounded-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/avatar-1.webp" alt="" class="wp-image-56" style="width:132px;height:132px"/></figure>
<!-- /wp:image -->
