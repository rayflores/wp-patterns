 ...
 * Slug: hpu24/card-call-to-action
 * Description:
...
<p class="has-base-color has-text-color">Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the hpu24 block theme. No coding skills required. Anyone can do it!</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
