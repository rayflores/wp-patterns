 ...
 * Slug: hpu24/text-and-details-card
 * Description:
 * Categories: hpu24/call-to-action, hpu24/hero, hpu24/features, hpu24/card
...
<h2 class="wp-block-heading has-base-color has-text-color">Download hpu24 for free today and start building</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"main-accent"} -->
<p class="has-main-accent-color has-text-color">hpu24 ships with a growing collection of design patterns that cohesively click together. Drag, drop, mix, and match patterns to create stunning designs in just a few minutes. </p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button">Download hpu24</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/avatar-2.webp" alt="" class="wp-image-57" style="width:75px;height:75px"/></figure>
<!-- /wp:image -->
