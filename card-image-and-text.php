 ...
 * Slug: hpu24/image-and-text-card
 * Description:
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/computer-hands.webp" alt="" class="wp-image-43"/></figure>
<!-- /wp:image -->
