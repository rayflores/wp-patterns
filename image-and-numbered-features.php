 ...
 * Slug: hpu24/image-and-numbered-features
 * Description:
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/computer-hands.webp","id":43,"dimRatio":0,"minHeightUnit":"px","isDark":false,"style":{"color":{"duotone":["#462CFF","#ECE8FF"]},"dimensions":{"aspectRatio":"1"}}} -->
<div class="wp-block-cover is-light"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-43" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/computer-hands.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…"} -->
...
<!-- wp:paragraph -->
<p>Your website deserves to look pixel-perfect on every device. hpu24 ensures your entire design scales down gracefully automagically.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p>We obsess over performance so you don’t have to. hpu24 is super lightweight and scores top marks on Google PageSpeed Insights.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
