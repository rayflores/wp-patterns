 ...
 * Slug: hpu24/big-text-call-to-action-card
 * Description:
 * Categories: hpu24/card, hpu24/call-to-action
 ...
 */
?>
<!-- wp:cover {"overlayColor":"main","isUserOverlayColor":true,"minHeightUnit":"px","contentPosition":"center center","style":{"color":{"duotone":"unset"},"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large"}}},"className":"is-style-default"} -->
...
<p class="has-main-accent-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Explore hpu24</p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-left has-main-accent-color has-text-color" style="font-style:normal;font-weight:400">Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the hpu24 block theme. No coding skills required.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" href="https://olliewp.com">Get Started Today →</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
