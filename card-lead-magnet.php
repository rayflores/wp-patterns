...
<div class="wp-block-cover is-light is-style-rounded-cover" style="min-height:281px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-33150" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/skateboarding.webp" style="object-position:44% 48%" data-object-fit="cover" data-object-position="44% 48%"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…"} -->
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Download hpu24</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"medium"} -->
<p class="has-medium-font-size" style="font-style:normal;font-weight:600">Start using the powerful new WordPress editor with hpu24</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Start creating beautiful, fully-customizable websites with the new WordPress Site Editor and the hpu24 block theme. </p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100 lemonsqueezy-button"><a class="wp-block-button__link wp-element-button" href="https://olliewp.com">Download hpu24 for free!</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
